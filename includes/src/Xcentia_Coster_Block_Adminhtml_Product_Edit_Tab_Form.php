...
class Xcentia_Coster_Block_Adminhtml_Product_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $frval = json_decode($formValues['content'], TRUE);
        $fieldset->addField(
            'box_name',
            'text',
            array(
                'label' => Mage::helper('xcentia_coster')->__('Product Name'),
                'name'  => 'box_name',
                'required'  => true,
                'class' => 'required-entry',
                'value' => $frval['Name']
        ...
        $fieldset->addField(
            ...
            'text',
            array(
                'label' => Mage::helper('xcentia_coster')->__('Box Length'),
                'name'  => 'box_length',
                'required'  => false,
                'class' => 'required-entry',
                'value' => $frval['BoxSize']['Length']
           )
        );
        $fieldset->addField(
            'box_width',
            'text',
            array(
                'label' => Mage::helper('xcentia_coster')->__('Box Width'),
                'name'  => 'box_width',
                'required'  => false,
                'class' => '',
                'value' => $frval['BoxSize']['Width']
           )
        );
        $fieldset->addField(
            'box_height',
            'text',
            array(
                'label' => Mage::helper('xcentia_coster')->__('Box Height'),
                'name'  => 'box_height',
                'required'  => false,
                'class' => '',
                'value' => $frval['BoxSize']['Height']
           )
        );
