...
class Xcentia_Coster_Model_Observer {
    ...
    public function getSingleProduct() {
        ...
        echo $importdate = date("d-m-Y H:i:s", strtotime("now"));
    ...
    public function getProducts() {
        ...
        //echo "Total Products: " . count($products); die;
    ...
    public function syncCosterInventory() {
        ...
        $log = "Include Inventory sync started at: ".$importdate;
    ...
    public function updateInventory() {
        ...
        $importdate = date("d-m-Y H:i:s", strtotime("now"));
        $log = "Check Update Inventory started at: ".$importdate;
        Mage::log($log, null, 'inventory_sync.log', true);
