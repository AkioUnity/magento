 ...
 */
/**
 * Collection admin grid block
 *
 * @category    Xcentia
 * @package     Xcentia_Coster
 * @author      Ultimate Module Creator
 */
class Xcentia_Coster_Block_Adminhtml_Collections_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Xcentia_Coster_Block_Adminhtml_Collections_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('xcentia_coster/collections')
            ->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'collection_code',
            array(
                'header'    => Mage::helper('xcentia_coster')->__('Collection Code'),
                'align'     => 'left',
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('collections');
     ...
     *
     * @access public
     * @param Xcentia_Coster_Model_Collections
     * @return string
     * @author Ultimate Module Creator
     */
