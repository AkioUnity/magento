...
//https://pricebusters.furniture/coster/product/recreate?sku=CB60RT
	public function recreateAction()
    {
        $sku=$this->getRequest()->getParam('sku');
        $proObj = Mage::getModel('xcentia_coster/product')->load($sku, 'sku');
        print_r($proObj);
...
//https://pricebusters.furniture/coster/product/create?key=gorhdufzk
