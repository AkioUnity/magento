 ...
 */
class Xcentia_Coster_Block_Adminhtml_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Xcentia_Coster_Block_Adminhtml_Product_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('xcentia_coster/product')
            ->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'sku',
            array(
                'header'    => Mage::helper('xcentia_coster')->__('SKU'),
                'align'     => 'left',
                'index'     => 'sku',
            )
        );
     ...
     *
     * @access public
     * @param Xcentia_Coster_Model_Product
     * @return string
     * @author Ultimate Module Creator
     */
