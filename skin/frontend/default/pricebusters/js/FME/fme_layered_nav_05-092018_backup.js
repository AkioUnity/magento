...
window.onload = function() {
    //Filterkey removed if it is a different category.
    if((localStorage.getItem("lastloc") !== null) && (localStorage.getItem("lastloc") != window.location.href)) {
        localStorage.removeItem('filterkey');
        localStorage.removeItem('lastloc');
        console.log('Filterkey removed.');
    }

    if (localStorage.getItem("filterkey") !== null) {
        
        var data = localStorage.getItem("filterkey");        
        ...
        if ( params['cat'] != 'undefined') {
            ...
            //localStorage.setItem('lastfilter', localStorage.getItem("filterkey"));
            //console.log(localStorage.getItem("lastfilter"));
            
            //localStorage.removeItem('filterkey');
            
            /*var currenturl = window.location.href;
            var c = currenturl.indexOf("categories");
            var cl = currenturl.length;
            console.log(currenturl);

            var lastloc = localStorage.getItem("lastloc");
            var l = lastloc.indexOf("categories");
            var ll = lastloc.length;
            console.log(lastloc);

            if(currenturl == lastloc) {
                localStorage.setItem('lastfilter', data);
                localStorage.removeItem('filterkey');
        ...
        console.log("Warning: No filter data found!!!");
    }
    //localStorage.setItem('lastloc', window.location.href);
